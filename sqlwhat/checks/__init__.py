from sqlwhat.checks.has_funcs import has_no_error, has_result, has_nrows, has_ncols, has_equal_value
from sqlwhat.checks.check_funcs import allow_error, check_column, check_row, check_all_columns, \
                                       lowercase, check_result, check_query
