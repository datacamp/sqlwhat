from sqlwhat.checks.check_funcs import allow_error, has_error, has_result, has_nrows, has_ncols, check_col, check_row, check_solution_cols, lowercase, is_equal, check_result
