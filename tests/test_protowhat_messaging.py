...
@pytest.mark.parametrize('query, path, target_desc', [
    ...
    (
        ...
        [[check_node, ['SelectStmt']], [check_edge, ['from_clause']], [check_edge, ['left']]],
        None # Doesn't generate anything for now!
    ),
    (
        'SELECT a FROM b INNER JOIN c HAVING(d)',
        [[check_node, ['SelectStmt']], [check_node, ['JoinExpr']], [check_edge, ['left']]],
    ...
    (
        ...
        [[check_node, ['SelectStmt']], [check_edge, ['where_clause']], [check_edge, ['left']]],
...
@pytest.mark.parametrize('stu, path, msg', [
    (
        '', 
        [[check_node, ['SelectStmt']], [check_node, ['JoinExpr']], [check_edge, ['left']], [has_equal_ast, []]],
    ...
    (
        ...
        'SELECT a FROM c INNER JOIN b HAVING(d)',
        [[check_node, ['SelectStmt']], [check_edge, ['from_clause']], [check_edge, ['left']], [has_equal_ast, []]],
...
@pytest.mark.parametrize('stu, path, msg', [
    ...
    (
        'SELECT a FROM b ORDER BY b', 
        [[check_node, ['SelectStmt']], [check_edge, ['order_by_clause']], [check_node, ['SortBy']], [has_equal_ast, []]],
